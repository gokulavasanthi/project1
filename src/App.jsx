...
function App() {
  ...
  // const [name, setname] = useState("vasanthi")


  // const [age, setage] = useState(21)

  // const [dob, setdob] = useState("17-07-2003")
  ...
  return (
    ...
    <h2>vasanthi</h2> */}
      ...
      {/* <ProductComp/> */}
{/* 
      <PropsEg data={data} a = {name} b = {age} c={dob}/>
...
{islogin ? <ApiCallWithBtn/>:<h1>Log Out</h1>} */}
